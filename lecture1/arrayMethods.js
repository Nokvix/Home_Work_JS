...
// const res = arr2.every(el => arr1.includes(el)); // every - каждый (проходит по массиву и проверяет все ли элеметы
// // соответствуют какому-то условию); includes - проверяет содержится ли элемент
const res = arr2.some(el => arr1.includes(el)); // some - хотя один элемент из arr2 есть в arr1?
console.log(res);